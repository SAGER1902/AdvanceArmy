...
public class EntitySA_F35 extends EntitySA_AirBase{
	public EntitySA_F35(EntityType<? extends EntitySA_F35> sodier, World worldIn) {
		...
		this.min_height = 20;
		this.icon1tex = null;
		this.icon2tex = new ResourceLocation("advancearmy:textures/hud/f35icon.png");
		seatView3X=0F;
		seatView3Y=-4F;
		seatView3Z=-12F;
		this.noCulling = true;
		...
		this.tex = new ResourceLocation("advancearmy:textures/mob/f35.png");
	...
	public EntitySA_F35(FMLPlayMessages.SpawnEntity packet, World worldIn) {
