...
public class EntitySA_SU33 extends EntitySA_AirBase{
	public EntitySA_SU33(EntityType<? extends EntitySA_SU33> sodier, World worldIn) {
		...
		this.min_height = 20;
		this.icon1tex = null;
		this.icon2tex = new ResourceLocation("advancearmy:textures/hud/su33icon.png");
		seatView3X=0F;
		seatView3Y=-4F;
		seatView3Z=-12F;
		this.noCulling = true;
		...
		this.tex = new ResourceLocation("advancearmy:textures/mob/su33.png");
	...
	public EntitySA_SU33(FMLPlayMessages.SpawnEntity packet, World worldIn) {
		super(AdvanceArmy.ENTITY_SU33, worldIn);
	}
	...
	public void weaponActive1(){
		...
		40, 5F, 1.1F, 3, false, 1, 0.001F, 200, 0);
	}
	public void weaponActive2(){
		...
		this.getX(), this.getY(), this.getZ(),this.yRot, this.turretPitch,
		25, 16F, 1.5F, 1, false, 1, 0.01F, 50, 0);
	}
