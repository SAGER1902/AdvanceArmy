...
public class EntitySA_M2hb extends EntitySA_TurretBase{
	public EntitySA_M2hb(EntityType<? extends EntitySA_M2hb> sodier, World worldIn) {
		...
		this.tex = new ResourceLocation("advancearmy:textures/mob/m2hb.png");
		...
		this.reloadSound1 = SASoundEvent.reload_mag.get();
		this.firesound1 = SASoundEvent.fire_m2hb.get();
		this.weaponCount = 1;
		this.w1icon="wmlib:textures/hud/heat120mm.png";
	}

	public EntitySA_M2hb(FMLPlayMessages.SpawnEntity packet, World worldIn) {//
