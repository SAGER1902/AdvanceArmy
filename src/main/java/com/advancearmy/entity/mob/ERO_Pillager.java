...
public class ERO_Pillager extends EntityMobSquadBase{
	public ERO_Pillager(EntityType<? extends ERO_Pillager> sodier, World worldIn) {
		super(sodier, worldIn);
		this.xpReward = 3;
	}

	public ERO_Pillager(FMLPlayMessages.SpawnEntity packet, World worldIn) {
		super(AdvanceArmy.ENTITY_PI, worldIn);
	}
	...
	public void startSummon(){
		...
		if (level.random.nextInt(4) == 1)SummonEntity.wildSummon(level, this.getX(), this.getY(), this.getZ() + 5, 33, true, this.getTeam(), 4);
		int summonType = -1;
