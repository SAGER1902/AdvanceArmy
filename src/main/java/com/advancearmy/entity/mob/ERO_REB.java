...
public class ERO_REB extends EntityMobSquadBase{
	public ERO_REB(EntityType<? extends ERO_REB> sodier, World worldIn) {
	...
	public ERO_REB(FMLPlayMessages.SpawnEntity packet, World worldIn) {
		super(AdvanceArmy.ENTITY_REB, worldIn);
	}
