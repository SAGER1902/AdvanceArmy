...
public class EntitySA_Swun extends EntitySA_SquadBase{
	public EntitySA_Swun(EntityType<? extends EntitySA_Swun> sodier, World worldIn) {
		super(sodier, worldIn);
		canDrop = true;
		//this.unittex = new ResourceLocation("advancearmy:textures/item/item_spawn_swun.png");
	}
	public EntitySA_Swun(FMLPlayMessages.SpawnEntity packet, World worldIn) {
		super(AdvanceArmy.ENTITY_SWUN, worldIn);
	}
