...
public class EntitySA_BMP2 extends EntitySA_LandBase{
	public EntitySA_BMP2(EntityType<? extends EntitySA_BMP2> sodier, World worldIn) {
		...
		this.icon1tex = new ResourceLocation("advancearmy:textures/hud/bmp2head.png");
		this.icon2tex = new ResourceLocation("advancearmy:textures/hud/bmp2body.png");
		this.obj = new SAObjModel("advancearmy:textures/mob/bmp2.obj");
		this.tex = new ResourceLocation("advancearmy:textures/mob/bmp2.png");
		this.magazine = 100;
	...
	public EntitySA_BMP2(FMLPlayMessages.SpawnEntity packet, World worldIn) {//
		super(AdvanceArmy.ENTITY_BMP2, worldIn);
	}
	...
	public void weaponActive2(){
		...
		ax + this.getX(), this.getY()+b, az + this.getZ(),this.turretYaw, this.turretPitch,
		400, 4F, 1.5F, 4, false, 1, 0.01F, 150, 1);
	}
}