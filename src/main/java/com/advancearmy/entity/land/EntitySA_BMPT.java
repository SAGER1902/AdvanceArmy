...
public class EntitySA_BMPT extends EntitySA_LandBase{
	public EntitySA_BMPT(EntityType<? extends EntitySA_BMPT> sodier, World worldIn) {
		...
		this.icon1tex = new ResourceLocation("advancearmy:textures/hud/bmpthead.png");
		this.icon2tex = new ResourceLocation("advancearmy:textures/hud/bmptbody.png");
		this.obj = new SAObjModel("advancearmy:textures/mob/bmpt.obj");
		this.tex = new ResourceLocation("advancearmy:textures/mob/bmpt.png");
	...
	public EntitySA_BMPT(FMLPlayMessages.SpawnEntity packet, World worldIn) {//
		super(AdvanceArmy.ENTITY_BMPT, worldIn);
	}
	...
	public void weaponActive2(){
		...
		350, 2F, 1.5F, 2, false, 1, 0.01F, 150, 0);
	}
}