...
public class EntitySA_LAVAA extends EntitySA_LandBase{
	...
	public EntitySA_LAVAA(EntityType<? extends EntitySA_LAVAA> sodier, World worldIn) {
	...
	public EntitySA_LAVAA(FMLPlayMessages.SpawnEntity packet, World worldIn) {//
		super(AdvanceArmy.ENTITY_LAVAA, worldIn);
	}
