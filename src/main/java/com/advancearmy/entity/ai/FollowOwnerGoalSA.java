...
public class FollowOwnerGoalSA extends Goal {
   ...
   public FollowOwnerGoalSA(TameableEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
      ...
      if (!(p_i225711_1_.getNavigation() instanceof GroundPathNavigator) && !(p_i225711_1_.getNavigation() instanceof FlyingPathNavigator)) {
         throw new IllegalArgumentException("Unsupported mob type for FollowOwnerGoalSA");
      }
   }

   public boolean canUse() {
	   LivingEntity livingentity = this.tamable.getOwner();
	   if(this.tamable instanceof EntitySA_SoldierBase){
		  EntitySA_SoldierBase soldier = (EntitySA_SoldierBase)this.tamable;
		  if(soldier.getMoveType()!=0){
			return false;
		  }else{
