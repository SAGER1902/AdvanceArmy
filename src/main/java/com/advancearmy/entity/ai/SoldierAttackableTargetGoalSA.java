...
public class SoldierAttackableTargetGoalSA<T extends LivingEntity> extends SoldierTargetGoalSA {
	...
	public SoldierAttackableTargetGoalSA(EntitySA_SoldierBase soldier, Class<T> classt, int count, float height, boolean istrue, boolean istrue2, @Nullable Predicate<LivingEntity> predicate) {
		this(soldier,classt,count,height, istrue, istrue2,predicate,0,0);
	}
	public SoldierAttackableTargetGoalSA(EntitySA_SoldierBase soldier, Class<T> classt, int count, float height, boolean istrue, boolean istrue2, @Nullable Predicate<LivingEntity> predicate, float maxrange, float minrange) {
	...
	public void findTarget() {
		...
		if (this.targetType != PlayerEntity.class && this.targetType != ServerPlayerEntity.class) {
			...
			this.targetType, this.targetConditions, this.mob, this.mob.getX(), this.mob.getEyeY(), this.mob.getZ(), 
