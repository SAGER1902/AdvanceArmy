...
@OnlyIn(Dist.CLIENT)
public class SupportRenderer extends MobRenderer<SupportPoint, ModelNone<SupportPoint>>{
	...
	*/
    ...
    public SupportRenderer(EntityRendererManager renderManagerIn)
    {
    ...
    public void render(SupportPoint entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
