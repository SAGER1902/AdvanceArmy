...
{
	public ResourceLocation tex = new ResourceLocation("advancearmy:textures/mob/m1tank.png");
	private static final SAObjModel m2hb = new SAObjModel("advancearmy:textures/mob/m2hb.obj");
	private static final ResourceLocation m2tex = new ResourceLocation("advancearmy:textures/mob/m2hb.png");
	private static final ResourceLocation m2tex2 = new ResourceLocation("advancearmy:textures/mob/m2hb_2.png");
	private static final ResourceLocation tex1 = new ResourceLocation("advancearmy:textures/mob/m1tank.png");
	private static final ResourceLocation tex2 = new ResourceLocation("advancearmy:textures/mob/m1tank2.png");
	private static final SAObjModel obj = new SAObjModel("advancearmy:textures/mob/m1tank.obj");
    ...
    public RenderTank(EntityRendererManager renderManagerIn)
    {
	...
	public boolean shouldRender(EntitySA_Tank p_225626_1_, ClippingHelper p_225626_2_, double p_225626_3_, double p_225626_5_, double p_225626_7_) {
      return true;
   }
   ...
   private static void setupGlintTexturing(float p_228548_0_) {
    ...
    private void render_part(EntitySA_Tank entity, String name){
		{
			obj.renderPart(name);//
			if(entity.getEnc()>0){//
	...
	private void render_wheel(EntitySA_Tank entity, String name, float x, float y, float z, float rote){
		GL11.glPushMatrix();//glstart
    ...
    public void render(EntitySA_Tank entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
		...
		GL11.glPopMatrix();//glend
		render_wheel(entity, "wheel1", 0, 0.98F+0.25F, 3.36F, entity.thpera);
		float range = 0;
		{
			range = 0.0005F;
		}
		...
		render_wheel(entity, "wheel1", 0, 0.48F+0.1F, 2.28F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, 1.21F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * -range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, 0.35F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, -0.5F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * -range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, -1.37F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, -2.26F, entity.thpera);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * -range, 0);
		GL11.glPopMatrix();//glend
		GL11.glPushMatrix();//glstart
		GL11.glTranslatef(0, Ax1 * (180F / (float)Math.PI) * range, 0);
		render_wheel(entity, "wheel1", 0, 0.48F, -3.16F, entity.thpera);
		GL11.glPopMatrix();//glend
		render_wheel(entity, "wheel2", 0, 0.97F+0.05F, -4.43F, entity.thpera);
		{
			...
			if(entity.getHealth()>0){
				GL11.glPushMatrix();//glstart
				{
					mc.getTextureManager().bind(m2tex);
				}
				GL11.glTranslatef(-0.64F, 3.51F, -1.06F);
				...
				GL11.glTranslatef(-0.64F, 3.51F, -0.68F);
