...
{
	public ResourceLocation tex = new ResourceLocation("advancearmy:textures/mob/soldier/gi.png");
    ...
    public RenderGI(EntityRendererManager renderManagerIn)
    {
    ...
    float iii;
    public void render(EntitySA_GI entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
		...
		if(entity.defend!=0){
			GL11.glPushMatrix();//glstart
			GlStateManager._scalef(entity.defend, entity.defend, entity.defend);
    ...
    private void renderlegs(EntitySA_GI entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderbody(EntitySA_GI entity, float limbSwing, float limbSwingAmount, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn){
    ...
    private void render_color(EntitySA_GI entity, String name){
    	GL11.glPushMatrix();//glstart
			/*GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			{
				{
