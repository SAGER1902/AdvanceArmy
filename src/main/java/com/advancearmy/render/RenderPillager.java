...
{
	public ResourceLocation tex2 = new ResourceLocation("advancearmy:textures/mob/soldier/ldz2.png");
    private static final SAObjModel obj2 = new SAObjModel("advancearmy:textures/mob/soldier/ldz2.obj");
	
	public ResourceLocation tex = new ResourceLocation("advancearmy:textures/mob/soldier/ldz.png");
    ...
    public RenderPillager(EntityRendererManager renderManagerIn)
    {
    ...
    float iii;
    public void render(ERO_Pillager entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
    ...
    private void renderlegs(ERO_Pillager entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderbody(ERO_Pillager entity, float limbSwing, float limbSwingAmount, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn){
    ...
    private void render_color(ERO_Pillager entity, String name){
    	GL11.glPushMatrix();//glstart
			/*GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			{
				{
