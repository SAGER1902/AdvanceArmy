...
{
	/*public ResourceLocation tex2 = new ResourceLocation("advancearmy:textures/mob/soldier/aohuan2.png");
    private static final SAObjModel obj2 = new SAObjModel("advancearmy:textures/mob/soldier/aohuan2.obj");*/
	
	public ResourceLocation tex = new ResourceLocation("advancearmy:textures/mob/soldier/aoh.png");
    ...
    private static final ResourceLocation huoshe_t1 = new ResourceLocation("advancearmy:textures/gun/huoshe_t1.jpg");
    private static final SAObjModel gema = new SAObjModel("advancearmy:textures/gun/gema.obj");
    private static final ResourceLocation gema_t = new ResourceLocation("advancearmy:textures/gun/gema_t.jpg");

    private static final SAObjModel rpg1 = new SAObjModel("advancearmy:textures/gun/echo.obj");
    private static final ResourceLocation rpg1t = new ResourceLocation("advancearmy:textures/gun/echo_t.jpg");
    private static final SAObjModel yingyan = new SAObjModel("advancearmy:textures/gun/yingyan.obj");
    private static final ResourceLocation yingyan_t = new ResourceLocation("advancearmy:textures/gun/yingyan_t.jpg");
	private static final ResourceLocation fire_tex = new ResourceLocation("advancearmy:textures/entity/flash/flash.png");
	
    public RenderAohuan(EntityRendererManager renderManagerIn)
    {
    ...
    float iii;
    public void render(EntityAohuan entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
    ...
    private void renderlegs(EntityAohuan entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderbody(EntityAohuan entity, float limbSwing, float limbSwingAmount, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn){
		Minecraft minecraft = Minecraft.getInstance();
		GL11.glPushMatrix();//glstart
    	obj.renderPart("body");
		SAObjModel wait_model = huoshe;
		minecraft.getTextureManager().bind(huoshe_t1);
		...
		if(entity.getWeaponId()==3){
			wait_model = gema;
			minecraft.getTextureManager().bind(gema_t);
		}
		if(entity.getWeaponId()==4){
			wait_model = yingyan;
			minecraft.getTextureManager().bind(yingyan_t);
		}
    ...
    private void render_color(EntityAohuan entity, String name){
    	GL11.glPushMatrix();//glstart
			/*GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			{
				{
