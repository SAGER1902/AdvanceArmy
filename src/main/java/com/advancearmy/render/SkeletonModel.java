...
@OnlyIn(Dist.CLIENT)
public class SkeletonModel<T extends ERO_Skeleton & IRangedAttackMob> extends BipedModel<T> {
   ...
   public void prepareMobModel(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      if ((itemstack.getItem() == Items.BOW||p_212843_1_.cooltime > 0) && p_212843_1_.isAggressive()) {
   ...
   public void setupAnim(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (p_225597_1_.isAggressive() && (itemstack.isEmpty() || itemstack.getItem() != Items.BOW ||p_225597_1_.cooltime == 0)) {
