...
public class RenderConscript extends MobRenderer<EntitySA_Conscript, ModelNone<EntitySA_Conscript>>
{
	...
	public ResourceLocation tex = new ResourceLocation("advancearmy:textures/mob/soldier/conscript.png");
    ...
    private static final ResourceLocation ak47t = new ResourceLocation("advancearmy:textures/gun/ak47.png");
    ...
    private static final ResourceLocation rpg1t = new ResourceLocation("advancearmy:textures/gun/rpg.png");
	...
	private static final ResourceLocation fire_tex = new ResourceLocation("advancearmy:textures/entity/flash/muzzleflash3.png");//flash
	
    public RenderConscript(EntityRendererManager renderManagerIn)
    {
    ...
    float iii;
    public void render(EntitySA_Conscript entity, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn)
    {
    ...
    private void renderlegs(EntitySA_Conscript entity, float limbSwing, float limbSwingAmount, float partialTicks){
    ...
    private void renderbody(EntitySA_Conscript entity, float limbSwing, float limbSwingAmount, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn){
		Minecraft minecraft = Minecraft.getInstance();
		GL11.glPushMatrix();//glstart
    	obj.renderPart("body");
		if(entity.getWeaponId()==5)obj.renderPart("pyro");
		SAObjModel wait_model = ak47;
		minecraft.getTextureManager().bind(ak47t);
    ...
    private void render_color(EntitySA_Conscript entity, String name){
    	GL11.glPushMatrix();//glstart
			/*GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			{
				{
