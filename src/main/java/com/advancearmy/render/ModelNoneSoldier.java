...
@OnlyIn(Dist.CLIENT)
public class ModelNoneSoldier<T extends EntitySA_SoldierBase> extends BipedModel<T>{
   public ModelNoneSoldier() {
      this(0.0F, false);
   }

   public ModelNoneSoldier(float p_i46303_1_, boolean p_i46303_2_) {
      super(p_i46303_1_);
      if (!p_i46303_2_) {
